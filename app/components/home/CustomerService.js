...
export default async function CustomerService() {
  ...
  return (
    <div id="customerservice" className="bg-white py-10 md:py-16 lg:py-20">
      <div className="mx-auto grid max-w-[100rem] grid-cols-1 sm:gap-x-8 gap-y-10 px-6 lg:px-16 xl:grid-cols-3">
        <div className="mx-auto max-w-2xl lg:mx-0 ">
          <h2 className="text-xl sm:text-3xl font-bold tracking-tight text-gray-800 ">
        ...
        <ul className="mx-auto grid max-w-2xl grid-cols-1 sm:gap-x-6 gap-y-8 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:gap-x-8 xl:col-span-2">
