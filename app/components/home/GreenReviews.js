          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            ...
            <div className='font-bold text-xs mt-2 text-white'>Positive: <span className='opacity-50 font-extralight pl-1'>Professionalism, Responsiveness</span></div>
              <figure className="mt-10 flex flex-auto flex-col justify-between">
                <blockquote className="text-lg leading-8 text-white">
                  <p>
                    “My inspector Chris, was very professional. Left no opinions of his own but left no detail untouched. 
                    He explained each of his findings and left great detail in his report. I am confident in the overall experience 
                    and would definitely recommend him/ this company to anyone in need of a detailed inspection. Thank you so much 
                    for your time, patients, and answers to all my questions.”
                  </p>
                </blockquote>
                <figcaption className="mt-10 flex items-center gap-x-6">
                  ...
                  <div className="text-base">
                    ...
                    <div className="mt-0.5 text-white opacity-40">Home Inspection</div>
                  </div>
                </figcaption>
              </figure>
            </div>
            ...
            <div className='font-bold text-xs mt-2 text-white'>Positive: <span className='opacity-50 font-extralight pl-1'>Professionalism, Quality, Responsiveness</span></div>
              ...
              <figure className="mt-10 flex flex-auto flex-col justify-between">
                <blockquote className="text-lg leading-8 text-white">
                  <p>
                    “Very thorough and professional service. Troy walked me through all the important features of the structure 
                    and was knowledgeable and adept at identifying hazards and deficiencies. He was specific with his terminology 
                    and kept things simple where I could understand. I highly recommend this company.”
                  </p>
                </blockquote>
                <figcaption className="mt-10 flex items-center gap-x-6">
                  <img
